...
func usage(w io.Writer) {
	...
	fmt.Fprintln(w, "                               --build [path] censuses a solution of project references")
	fmt.Fprintln(w, "                               (--builders <n> as in build); every project is reported")
	fmt.Fprintln(w, "                               under `projects`, and each file says which one it is from")
